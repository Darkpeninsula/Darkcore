...
class SmartScript
{
    public:
        ...
        GameObject* FindGameObjectNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            CellCoord p(Darkcore::ComputeCellCoord(searchObject->GetPositionX(), searchObject->GetPositionY()));
            Cell cell(p);

            Darkcore::GameObjectWithDbGUIDCheck goCheck(*searchObject, guid);
            Darkcore::GameObjectSearcher<Darkcore::GameObjectWithDbGUIDCheck> checker(searchObject, gameObject, goCheck);
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            Darkcore::CreatureWithDbGUIDCheck target_check(searchObject, guid);
            Darkcore::CreatureSearcher<Darkcore::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
