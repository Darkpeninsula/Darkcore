...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    Darkcore::CreatureListSearcher<Darkcore::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
    return list;
}
...
{
    std::list<Creature*> list;
    Darkcore::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    Darkcore::PlayerAtMinimumRangeAway check(me, minimumRange);
    Darkcore::PlayerSearcher<Darkcore::PlayerAtMinimumRangeAway> searcher(me, player, check);
