...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
  if (me->ToTotem()->GetTotemType() != TOTEM_ACTIVE)
    ...
    {
        victim = NULL;
        Darkcore::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Darkcore::UnitLastSearcher<Darkcore::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
