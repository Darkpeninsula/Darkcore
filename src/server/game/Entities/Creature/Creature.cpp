...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Cell cell(p);
        cell.SetNoCreate();
        Darkcore::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        Darkcore::CreatureLastSearcher<Darkcore::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<Darkcore::CreatureLastSearcher<Darkcore::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        Darkcore::NearestHostileUnitCheck u_check(this, dist);
        Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        Darkcore::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Darkcore::UnitLastSearcher<Darkcore::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    Darkcore::NearestPlayerInObjectRangeCheck checker(this, distance);
    Darkcore::PlayerLastSearcher<Darkcore::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                Darkcore::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                Darkcore::CreatureListSearcher<Darkcore::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<Darkcore::CreatureListSearcher<Darkcore::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    Darkcore::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
    Darkcore::CreatureWorker<Darkcore::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<Darkcore::CreatureWorker<Darkcore::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!Darkcore::IsValidMapCoord(x, y, z, o))
    {
