        ...
        case GO_READY:
        {
            ...
            if (isSpawned())
            {
                ...
                if (goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Darkcore::AnyUnfriendlyNoTotemUnitInObjectRangeCheck checker(this, owner, radius);
                        Darkcore::UnitSearcher<Darkcore::AnyUnfriendlyNoTotemUnitInObjectRangeCheck> searcher(this, ok, checker);
                    ...
                    else                                        // environmental trap
                    {
                        ...
                        // affect only players
                        Player* player = NULL;
                        Darkcore::AnyPlayerInObjectRangeCheck checker(this, radius);
                        Darkcore::PlayerSearcher<Darkcore::AnyPlayerInObjectRangeCheck> searcher(this, player, checker);
...
void GameObject::TriggeringLinkedGameObject(uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        Darkcore::NearestGameObjectEntryInObjectRangeCheck go_check(*target, trapEntry, range);
        Darkcore::GameObjectLastSearcher<Darkcore::NearestGameObjectEntryInObjectRangeCheck> checker(this, trapGO, go_check);

        TypeContainerVisitor<Darkcore::GameObjectLastSearcher<Darkcore::NearestGameObjectEntryInObjectRangeCheck>, GridTypeMapContainer > object_checker(checker);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    Darkcore::NearestGameObjectFishingHole u_check(*this, range);
    Darkcore::GameObjectSearcher<Darkcore::NearestGameObjectFishingHole> checker(this, ok, u_check);

    TypeContainerVisitor<Darkcore::GameObjectSearcher<Darkcore::NearestGameObjectFishingHole>, GridTypeMapContainer > grid_object_checker(checker);
