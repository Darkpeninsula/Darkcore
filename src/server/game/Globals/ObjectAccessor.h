...
#ifndef DARKCORE_OBJECTACCESSOR_H
#define DARKCORE_OBJECTACCESSOR_H
...
class HashMapHolder
{
    public:
        ...
        {
            DARKCORE_WRITE_GUARD(LockType, i_lock);
        ...
        {
            DARKCORE_READ_GUARD(LockType, i_lock);
...
class ObjectAccessor
{
    ...
    public:
        ...
        template<class T> static T* GetObjectInWorld(uint32 mapid, float x, float y, uint64 guid, T* /*fake*/)
        {
            ...
            CellCoord q = Darkcore::ComputeCellCoord(obj->GetPositionX(), obj->GetPositionY());
            if (!q.IsCoordValid())
            {
        ...
        {
            DARKCORE_GUARD(ACE_Thread_Mutex, i_objectLock);
