...
typedef UNORDERED_MAP<int32, CoreStringLocale> CoreStringLocaleContainer;
...
class ObjectMgr
{
    ...
    public:
        ...
        {
            CoreStringLocaleContainer::const_iterator itr = _coreStringLocaleStore.find(entry);
        ...
        {
            DARKCORE_GUARD(ACE_Thread_Mutex, _creatureRespawnTimesMutex);
        ...
        {
            DARKCORE_GUARD(ACE_Thread_Mutex, _goRespawnTimesMutex);
    ...
    private:
        ...
        CoreStringLocaleContainer _coreStringLocaleStore;
