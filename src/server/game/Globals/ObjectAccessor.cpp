...
{
    DARKCORE_READ_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        DARKCORE_WRITE_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
        ...
        CellCoord cellCoord = Darkcore::ComputeCellCoord(corpse->GetPositionX(), corpse->GetPositionY());
