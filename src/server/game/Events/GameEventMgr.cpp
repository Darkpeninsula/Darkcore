...
void GameEventMgr::RunSmartAIScripts(uint16 event_id, bool activate)
{
    ...
    {
        DARKCORE_READ_GUARD(HashMapHolder<Creature>::LockType, *HashMapHolder<Creature>::GetLock());
    ...
    {
        DARKCORE_READ_GUARD(HashMapHolder<GameObject>::LockType, *HashMapHolder<GameObject>::GetLock());
