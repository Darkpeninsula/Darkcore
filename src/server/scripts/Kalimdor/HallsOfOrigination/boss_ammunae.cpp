    ...
    public:
        ...
        struct boss_ammunaeAI : public BossAI
        {
            ...
            void RampartSummon(uint32 entry, float distance)
            {
                ...
                Darkcore::AllCreaturesOfEntryInRange checker(me, entry, distance);
                Darkcore::CreatureListSearcher<Darkcore::AllCreaturesOfEntryInRange> searcher(me, pCreatureList, checker);
