            ...
            if (phase == PHASE_START || phase == PHASE_END)
            {
                ...
                else
                {
                    if (bellowingRoarTimer <= diff)
                    {
                        ...
                        Darkcore::GameObjectInRangeCheck check(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 15);
                        Darkcore::GameObjectLastSearcher<Darkcore::GameObjectInRangeCheck> searcher(me, floor, check);
