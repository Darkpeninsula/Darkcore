                    ...
                    if (Creature* shadowy1 = me->GetCreature(*me, Shadowy1GUID))
                    {
                        switch (Phase)
                        {
                            ...
                            case 13:
                            {
                                ...
                                Darkcore::AnyPlayerInObjectRangeCheck checker(me, 25.0f);
                                Darkcore::PlayerListSearcher<Darkcore::AnyPlayerInObjectRangeCheck> searcher(me, players, checker);
                    ...
                    if (Creature* Investigator2 = me->FindNearestCreature(NPC_INVESTIGATOR3, 50.0f, true))
                    {
                        switch (Phase)
                        {
                            ...
                            case 21:
                            {
                                ...
                                Darkcore::AnyPlayerInObjectRangeCheck checker(me, 50.0f);
                                Darkcore::PlayerListSearcher<Darkcore::AnyPlayerInObjectRangeCheck> searcher(me, players, checker);
