        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId)
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        Darkcore::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
                    Darkcore::AnyPlayerInObjectRangeCheck check(me, 60.0f);
                    Darkcore::PlayerSearcher<Darkcore::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            Darkcore::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                Darkcore::MostHPMissingInRange u_check(me, 60.0f, 0);
                Darkcore::CreatureLastSearcher<Darkcore::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(Darkcore::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<Unit*>& unitList)
            {
                ...
                Darkcore::RandomResizeList(unitList, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/)
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(Darkcore::ObjectDistanceOrderPred(player));
                bool instant = false;
